...
export var ReversiScene =  __class__ ('ReversiScene', [Scene], {
	...
	get __handle_mouseup () {return __get__ (this, function (self, event) {
		var __left0__ = self.__find_cell (event.offsetX, event.offsetY);
		var x = __left0__ [0];
		var y = __left0__ [1];
	...
	get __handle_mousemove () {return __get__ (this, function (self, event) {
		var __left0__ = self.__find_cell (event.offsetX, event.offsetY);
		self.hoverX = __left0__ [0];
		self.hoverY = __left0__ [1];
	});},
	get __make_move () {return __get__ (this, function (self, move) {
		...
		self.think_until = -(1);
		if (len (self.current_board) == 64 || self.consecutive_passes >= 2 || self.current_board.count (WHITE) == 0 || self.current_board.count (BLACK) == 0) {
	...
	get __draw_board () {return __get__ (this, function (self, ctx) {
		...
		if (self.hoverX !== null && self.current_board.is_move (self.hoverX, self.hoverY)) {
